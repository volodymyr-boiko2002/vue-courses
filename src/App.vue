    ...
    <div class="container pt-5">
      <div class="row gx-0">
        ...
        <div class="row gx-0 d-flex justify-content-between">
          <category-filters v-bind:categories="categories" @filter="filterByCategory"></category-filters>
          <div class="col-md-4 px-md-0">
            <input v-model="searchText" class="form-control mt-md-0 mt-2" placeholder="Search">
          </div>
        </div>
        <course-info v-bind:courses="filteredList"></course-info>
      </div>
    </div>
  </div>
</template>
...
.form-control:focus {
  ...
  border-color: #c5bbf2;
  /*border-color: #dfd8ff;*/
  box-shadow: 0 0 0 0.25rem #dfd8ff;
}
